...
import { Droplet, Mail, Lock, User, MapPin, Droplets, ChevronLeft, Phone, Heart, Users, Bell, FileText, Check } from "lucide-react";
...
export default function Auth() {
  ...
  const [step, setStep] = useState(mode === "login" ? 0 : 0);
  ...
  const [role, setRole] = useState<"donor" | "requester" | "both">("both");
    ...
    return (
      <div className="min-h-screen flex flex-col" dir="rtl">
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-6">
          ...
          >
            <Droplet className="w-12 h-12 text-primary" fill="currentColor" />
          </motion.div>
          ...
          >
            ...
            <motion.button
              ...
              disabled={isLoading}
              whileTap={{ scale: 0.97 }}
              className="w-full bg-gradient-to-r from-primary to-primary/90 text-primary-foreground rounded-2xl py-4 font-semibold text-[17px] mt-2 shadow-lg glow-primary disabled:opacity-50"
            >
  ...
  // Signup View - Multi-step like DonorOnboarding
  return (
    <div className="min-h-screen flex flex-col" dir="rtl">
      {/* Progress bar */}
      {step > 0 && (
        ...
        {step === 2 && (
          ...
          >
            ...
            <div className="mb-auto">
              <label className="text-sm font-medium text-foreground mb-3 block">نوع الحساب</label>
              <div className="flex gap-2">
                {[
          ...
          >
            ...
            <div className="glass-card rounded-2xl p-4 space-y-3 mb-6">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="font-medium text-foreground">
                  {role === "donor" ? "متبرع" : role === "requester" ? "طالب" : "متبرع وطالب"}
                </span>
              </div>
            </div>
            ...
            <div className="space-y-3 mb-auto">
              <motion.button
                ...
                className={cn(
                  "w-full flex items-center gap-3 glass-card rounded-2xl p-4 text-right transition-all",
                  acceptTerms && "ring-2 ring-primary/50"
                )}
              >
                <div className={cn(
                  "w-6 h-6 rounded-lg flex items-center justify-center transition-all",
                  acceptTerms ? "bg-primary" : "bg-muted"
                )}>
            ...
            <motion.button
              ...
              className="w-full bg-gradient-to-r from-primary to-primary/90 text-primary-foreground rounded-2xl py-4 font-semibold text-[17px] mt-6 shadow-lg glow-primary disabled:opacity-50"
            >
      ...
      <Drawer open={termsOpen} onOpenChange={setTermsOpen}>
        <DrawerContent>
          <DrawerHeader>
            <DrawerTitle>الشروط والأحكام</DrawerTitle>
          </DrawerHeader>
